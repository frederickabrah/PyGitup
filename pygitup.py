...
# ==============================================================================
# SECTION 10: UPLOAD/UPDATE A PROJECT DIRECTORY
# ==============================================================================
...
Examples:
  ...
  python pygitup.py --mode release --repo myproject --version v1.0.0
    ...
    parser.add_argument(
        "--mode", 
        choices=["project", "file", "batch", "template", "release", "multi-repo", "scan-todos", "offline-queue", "process-queue", "request-review", "smart-push"],
        help="Operation mode"
    )
